...
const HeroSection = () => {
  return <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden bg-gradient-to-b from-background via-secondary/30 to-background">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-accent/5 rounded-full blur-3xl animate-pulse-slow" style={{
      animationDelay: '2s'
    }} />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Headline */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-6 fade-in-up text-foreground" style={{
          animationDelay: '0.1s'
        }}>
            Engage Smarter,
            <br />
          ...
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 fade-in-up" style={{
          animationDelay: '0.2s'
        }}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto fade-in-up" style={{
          animationDelay: '0.4s'
        }}>
