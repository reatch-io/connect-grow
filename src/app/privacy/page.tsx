          ...
          <div className="space-y-8 text-foreground/90">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  <strong>Usage Data:</strong> Platform activity, feature usage,
                  and interaction logs
                </li>
                <li>
                  <strong>Communication Data:</strong> Messages, templates, and
                  campaign content sent through our platform
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  Communicate service updates, security notices, and support
                  responses
                </li>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                trusted third-party service providers (such as messaging,
                hosting, analytics, and payment processors) solely for the
                purpose of delivering and improving our Services. All such
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                loss, misuse, or alteration. However, no system is 100% secure,
            ...
            <section>
              ...
              <p className="leading-relaxed">
                We use cookies and similar technologies to analyze usage,
                improve functionality, and enhance user experience. You may
