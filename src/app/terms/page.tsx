          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                To access the Services, you must create an account. You are
                responsible for:
              </p>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                failed deliveries. We reserve the right to change pricing with
                prior notice.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                uninterrupted availability. Services may be suspended for
                maintenance, security, or operational reasons without liability.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Terms or misuse of the Services. Upon termination, your access
                will immediately cease. Certain provisions will survive
                termination.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                communicated via email or the platform. Continued use of the
